...
public class AvailableETicketListScreen extends ListActivity implements
		IPresentation {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (this.getIntent().getExtras() != null) {
			...
			if (obj != null && obj instanceof AvailableETicketTypesMessage) {
				final List<ETicketType> eTicketTypes = ((AvailableETicketTypesMessage) obj)
						.getAvailableETicketTypes();

				ArrayList<String> eTicketTypesStrings = new ArrayList<String>();
				for (ETicketType ett : eTicketTypes) {
					eTicketTypesStrings.add("Name: " + ett.getName()
							+ " Validity: " + ett.getValidMinutes()
							+ " Price: " + ett.getPrice());
				}

				setListAdapter(new ArrayAdapter<String>(this,
						R.layout.available_etickettypes, eTicketTypesStrings));
				...
				eTicketListView
						.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> parent,
								...
								// TextView eTicketTypeNameView = (TextView)
								// view;
								// String eTicketTypeName =
								// eTicketTypeNameView.getText().toString().split(" ")[1];

								ETicketType selectedETicketType = eTicketTypes
										.get(position);
